...
eyes_cascade = cv2.CascadeClassifier('src/cascades/data/third-party/frontalEyes35x16.xml')
nose_cascade = cv2.CascadeClassifier('src/cascades/data/third-party/Nose18x15.xml')
